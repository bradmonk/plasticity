function varargout = STARShiP(varargin)
% STARShiP MATLAB code for STARShiP.fig
%      STARShiP, by itself, creates a new STARShiP or raises the existing
%      singleton*.
%
%      H = STARShiP returns the handle to a new STARShiP or the handle to
%      the existing singleton*.
%
%      STARShiP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STARShiP.M with the given input arguments.
%
%      STARShiP('Property','Value',...) creates a new STARShiP or raises
%      the existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before STARShiP_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to STARShiP_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help STARShiP
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @STARShiP_OpeningFcn, ...
                   'gui_OutputFcn',  @STARShiP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before STARShiP is made visible.
function STARShiP_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to STARShiP (see VARARGIN)

% Choose default command line output for STARShiP
...
% UIWAIT makes STARShiP wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = STARShiP_OutputFcn(hObject, eventdata, handles)
