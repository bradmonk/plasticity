function [varargout] = ActinRotation2(varargin)
...
zoom(15)
% anotext({v1},{d1,'deee1'})
anotext({v1, 'v1'},{Po, 'Po'},{Pt, 'Pt'},{Pr, 'Pr'},{Dv, 'Dv',Dv+.05})
