...
%-------------------------
	...
	[Scell HKcell OKGO] = RobustSAP(Lon,Bon,Ron,Loff,Boff,Roff);
...
%-------------------------
	...
	if mod(aa,10)==0
    perc = aa/BRpoints;
    waitbar(perc,wbh,sprintf('%0.2f',perc*100))
	end
...
PLon  = linspace(Lon(1),Lon(2),BRpoints);
PLoff = linspace(Loff(1),Loff(2),BRpoints);

PBon  = linspace(Bon(1),Bon(2),BRpoints);
PBoff = linspace(Boff(1),Boff(2),BRpoints);

PRon  = linspace(Ron(1),Ron(2),BRpoints);
PRoff = linspace(Roff(1),Roff(2),BRpoints);
%-------------------------
nn = 0;
for aa = 1:BRpoints; 
for bb = 1:BRpoints; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%==========================================================%
assignin('base','BRpoints',BRpoints);
