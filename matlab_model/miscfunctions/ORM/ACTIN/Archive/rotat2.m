function [varargout] = rotat2(varargin)
...
% nFils = round(rad360 / (sqrt(tta^2+phi^2+psy^2)/1.5));
% nFils = round(rad360 / tta);
nFils = 20;
%---------------------------------------------%


Origin = ARxFun(Origin, 0, 0, 0);
Tip = ARxFun(Tip, 0, (70*dg2rad), 0);
