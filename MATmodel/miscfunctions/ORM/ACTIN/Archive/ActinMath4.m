...
%---------------------------------------------%
% DOT: {Po00 Po Pt Dv Pr v0 v1} {'d';'d';'o';'x';'s';'v';'v'};
%---------------------------------------------%
...
%---------------------------------------------%
simlegend({'Po00','Po','Pt','Dv','Pr','v0','v1'},Ph99);
%---------------------------------------------%
...
%---------------------------------------------%
anotext({v1, 'v1',v1-.1},{Po, 'Po'},{Pt, 'Pt'},{Pr, 'Pr'},{Dv, 'Dv',Dv+.1});
%---------------------------------------------%
