...
XYZcell = {DENxyz, SPI1xyz, SPI2xyz};
...
% dolfinXML(SPI1xyz,'alphaTriangulation')
dolfinXMLalpha(XYZcell,'alphaTriangulation',[1.3, 1.4, 1.4])
...
######  TR.ConnectivityList  ######
Triangulation connectivity list, represented as a matrix. 
...
NEIGHBRS = neighbors(TR)
VTXATTCH = vertexAttachments(TR)
VTXNRMLS = vertexNormal(TR)
FACENRMS = faceNormal(TR)
