...
\draw[fill=black] (\Xscalefactor * 1.62, \Yscalefactor * 0.01) circle (.05cm);
\draw[fill=black] (\Xscalefactor * 1.4, -\Yscalefactor * 0.005) circle (.05cm);
\draw (\Xscalefactor * 1.62, \Yscalefactor * 0.01) -- (\Xscalefactor * 1.4, -\Yscalefactor * 0.005);
\draw (\Xscalefactor * 1.4, -\Yscalefactor * 0.005 - 0.3) node{\scriptsize{\((\theta_0, x_0)\)}};
\end{tikzpicture}
\end{center}
